...
class CreateUserNdisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_ndis', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->unsignedInteger('user_id');
            $table->boolean('participant');
            $table->text('number')->nullable();
            $table->enum('type',['AGENCY','SELF','PLAN']);
