...
//    dd($user->userNdis,$user->userNiisq,$user->userAgedCare,$user->userPrivate);
    $request_detail = \App\Models\Request\Request::with(['userDetail', 'driverDetail'])->where('id', 'ae2d1f65-0d14-44a7-9ece-8fc68e11d1ca')->first();
