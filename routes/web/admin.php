...
//Fleet drivers
        ...
        Route::group(['prefix' => 'users', 'middleware' => 'permission:user-menu'], function () {
            ...
            Route::get('/fetch-extra-details', 'UserController@getUserExtraDetails')->name('admin.get.user.extra.details');
            Route::get('/create', 'UserController@create');
            Route::post('store', 'UserController@store');
            Route::get('edit/{user}', 'UserController@getById');
            Route::post('update/{user}', 'UserController@update')->name('admin.update.user');
