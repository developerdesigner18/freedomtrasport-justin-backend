...
//outstation rides
    ...
    Route::get('get-available-users', 'EtaController@getAvailableUsers');
    ...
    Route::middleware(role_middleware(Role::DRIVER))->group(function () {
        ...
        Route::post('respond-upcoming-ride', 'RequestAcceptRejectController@respondUpcomingRequest');
        ...
        Route::post('payment-confirm-special', 'DriverEndRequestController@paymentConfirmSpecial');
