    ...
    */
    public function respondRequest(AcceptRejectRequest $request)
    {
        ...
        */
        ...
        $userWithAdvanceDetails = User::with(['userAgedCare','userNdis','userNiisq','userPrivate'])->find($request_detail->user_id);

        $data = [
            'user_details' => $userWithAdvanceDetails
        ];
        return $this->respondSuccess($data);
    }

    public function respondUpcomingRequest(Request $request)
    {
        ...
        */
        ...
        if($request->input('is_accept')){
        $request_detail->update(['driver_id' => $driver->id,'accepted_at' => Carbon::now()]);
        }
