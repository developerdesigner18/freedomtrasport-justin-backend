...
class User extends Authenticatable implements CanSendOTPContract
{
    ...
    */
    ...
    public function userAgedCare()
    {
        return $this->hasOne(UserAgedCare::class, 'user_id', 'id');
    }

    public function userNdis()
    {
        return $this->hasOne(UserNdis::class, 'user_id', 'id');
    }

    public function userNiisq()
    {
        return $this->hasOne(UserNiisq::class, 'user_id', 'id');
    }

    public function userPrivate()
    {
        return $this->hasOne(UserPrivateInfo::class, 'user_id', 'id');
    }
