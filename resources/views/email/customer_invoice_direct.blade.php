...
{{ $data->pick_address }}
                                                                            ...
                                                                            @foreach($data->requestStops as $key => $stop)
                                                                                <tr style="vertical-align: top; text-align: left; width: 100%; padding: 0"
                                                                                    align="left">
                                                                                    <td style="word-break: break-word; border-collapse: collapse !important; vertical-align: top; text-align: left; display: table-cell; width: 80px !important; line-height: 16px; height: auto; padding: 0 0 0 0;"
                                                                                        align="left" valign="top">
            ...
            <span>
                <a style="text-decoration: none !important; color: #000000 !important"
                   rel="noreferrer">{{ now()->parse($data->completed_at)->setTimezone(env('SYSTEM_DEFAULT_TIMEZONE', 'Asia/Kolkata'))->format('h:i A') }}</a>
                                                                                    ...
                                                                                    <td style="word-break: break-word; border-collapse: collapse !important; vertical-align: top; text-align: left; display: table-cell; width: 17px !important; padding: 3px 2px 10px 2px;"
                                                                                        align="left" valign="top">
                                                                                        @if ($key < count($data->requestStops) - 1)
                                                                                            <img width="6" height="84px"
                                                                                                 src="{{ asset('invoice/Invoice_src_dest.png') }}"
                                                                                                 style="outline: none; text-decoration: none; float: left; clear: both; display: block; width: 6px !important; height: 84px; padding-top: 5px"
                                                                                                 align="left"
                                                                                                 class="CToWUd"/>
                                                                                    ...
                                                                                    <td style="word-break: break-word; border-collapse: collapse !important; vertical-align: top; text-align: left; display: table-cell; width: 197px; line-height: 16px; height: auto; padding: 0 0px 0 0;"
                                                                                        align="left" valign="top">
...
">
    ...
    ">
                                                            ...
                                                            font-weight: normal;
                                                            line-height: 18px;">
                                                                                                                        {{ $data->goodsTypeDetail->goods_type_name }}
                                                                                                                        - {{$data->goods_type_quantity }}
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                </tbody>
                                                                                                            </table>
